...
* @return　　先頭イテレータ
*/
CIterator CList::GetFirstNode()
{
	return CIterator(m_dummyFirst->m_next);
}
 ...
 * @return	末尾イテレータ
 */
CIterator CList::GetEndNode()
{
	return CIterator(m_dummyEnd->m_prev);
}
...
* @return　　先頭ダミーイテレータ
*/
CIterator CList::GetDummyFirst()
{
	return CIterator(m_dummyFirst);
}
/**
* @brief	末尾ダミーノードを指すイテレータの取得
* @return	末尾ダミーイテレータ
*/
CIterator CList::GetDummyEnd()
{
	return CIterator(m_dummyEnd);
}
